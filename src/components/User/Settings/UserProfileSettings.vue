      ...
      <div class="ui segment">
        ...
        <form class="ui form" @submit.prevent="updateProfile">
          <div class="field">
            ...
            <input type="text" name="name" v-model="name" required placeholder="Full name">
          </div>
          <div class="field">
          ...
          <div class="field">
            <label>Email</label>
            <input type="email" name="name" v-model="email" required placeholder="Email">
          </div>
          <div class="field">
            <label>Bio</label>
            <textarea rows="5" v-model="bio" placeholder="A breif bio of you"></textarea>
          </div>
          <div class="field">
